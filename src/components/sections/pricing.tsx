...
const plans = [
  {
    ...
    features: ["Single Platform (Web or Mobile)", "Standard UI/UX Design", "Core Features Implementation", "30 Days Support", "Cloud Deployment"],
    popular: false
  },
  {
    name: "Professional",
    ...
    features: ["Full-Stack Application", "Premium AI Integration", "Advanced Dashboard", "Priority Support", "Scalable Infrastructure", "SEO & Performance Optimization"],
    popular: true
  },
  {
    name: "Enterprise",
    ...
    features: ["Complex Multi-Platform Systems", "Custom AI/ML Models", "24/7 Dedicated Support", "Enterprise-Grade Security", "Internal Tooling", "Legacy System Integration"],
    popular: false
  }
]
