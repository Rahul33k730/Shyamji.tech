...
export default function Dashboard() {
  ...
  const chartOptions = {
    ...
    scales: {
      ...
      y: { grid: { color: "rgba(0, 0, 0, 0.05)" }, ticks: { color: "#9ca3af" } },
    },
  };
  ...
  return (
    <div className="space-y-8 pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-[#111827]">Dashboard Overview</h1>
          <p className="text-gray-500 mt-1">Welcome back, Admin. Here's what's happening today.</p>
        </div>
        <div className="flex gap-3">
          <button className="px-4 py-2 bg-white border border-gray-200 rounded-xl text-sm font-medium flex items-center gap-2 hover:bg-gray-50 transition-colors shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {statsWithIcons.map((stat, i) => (
          ...
          >
            <Card variant="glass" padding="md" className="bg-white border-gray-200 hover:border-blue-500/20 transition-all shadow-sm">
              ...
              <h3 className="text-2xl font-black tracking-tight text-[#111827]">{stat.value}</h3>
            </Card>
          </motion.div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <Card variant="glass" padding="lg" className="bg-white border-gray-200 h-full shadow-sm">
            <h3 className="text-lg font-bold mb-6 flex items-center gap-2 text-[#111827]">
              Growth Performance <span className="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">+24% YoY</span>
            </h3>
        ...
        <div>
          <Card variant="glass" padding="lg" className="bg-white border-gray-200 h-full shadow-sm">
            <h3 className="text-lg font-bold mb-6 text-[#111827]">Device Breakdown</h3>
            <div className="h-[200px] flex items-center justify-center">
              <Doughnut data={doughnutData} options={{ plugins: { legend: { position: "bottom", labels: { color: "#6b7280", font: { size: 10 } } } } }} />
            </div>
            <div className="mt-8 space-y-4">
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500">Direct Traffic</span>
                <span className="font-bold text-[#111827]">45%</span>
              </div>
              <div className="flex items-center justify-between text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card variant="glass" padding="lg" className="bg-white border-gray-200 shadow-sm">
          <h3 className="text-lg font-bold mb-6 text-[#111827]">Service Interest</h3>
        ...
        <Card variant="glass" padding="lg" className="bg-white border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-[#111827]">Recent Leads</h3>
            ...
            {(data?.recentLeads || []).map((lead, i) => (
              <div key={i} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                ...
                <div className="text-right">
                  <p className="text-xs font-bold text-gray-500">{lead.service}</p>
